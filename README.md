...
|----------|-------------|
| [SKILLS.md](docs/SKILLS.md) | All 21 skills detailed guide |
| [WORKFLOW.md](docs/WORKFLOW.md) | Typical workflows |
| [QUICK-START.md](docs/QUICK-START.md) | 5-minute guide |
| [case-study-2person-team.md](docs/case-study-2person-team.md) | 🆕 2-person team guide |
...
- Art pipeline: `art-bible`, `asset-spec`, `art-coordinator`
- Design validation: `player-evaluator` (multi-perspective GDD evaluation)
- Prototyping: `prototype-mode`
