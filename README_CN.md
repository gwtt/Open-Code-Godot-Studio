...
完成！你的项目现在拥有 21 个 Godot AI Skills。
...
| 文档 | 描述 |
|------|------|
| [SKILLS.md](docs/SKILLS.md) | 所有 21 个技能详细指南 |
| [WORKFLOW.md](docs/WORKFLOW.md) | 典型工作流程 |
| [QUICK-START.md](docs/QUICK-START.md) | 5 分钟入门 |
| [case-study-2person-team.md](docs/case-study-2person-team.md) | 🆕 2人小队开发指南 |
...
| **设计支持** | `brainstorm`, `game-designer`, `design-review`, `art-bible`, `asset-spec` |
...
- 美术管道: `art-bible`, `asset-spec`, `art-coordinator`
